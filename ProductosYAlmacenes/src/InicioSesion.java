...
public class InicioSesion extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel3.setBackground(new java.awt.Color(0, 82, 158));
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/OjoBuho.png"))); // NOI18N
    ...
    boolean loginExitoso = Controlador.iniciarSesion(usuario, password);

    if (loginExitoso) {
        // Cambiar al panel Menu dentro de tu VentanaPrincipal
